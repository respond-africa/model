...
class ClinicalReviewBaselineRuleGroup(CrfRuleGroup):
    ...
    class Meta:
        app_label = "respond_model_app"
        source_model = "respond_model_app.clinicalreviewbaseline"
...
class ClinicalReviewRuleGroup(CrfRuleGroup):
    ...
    class Meta:
        app_label = "respond_model_app"
        source_model = "respond_model_app.clinicalreview"
...
class MedicationsRuleGroup(CrfRuleGroup):
    ...
    class Meta:
        app_label = "respond_model_app"
        source_model = "respond_model_app.medications"
