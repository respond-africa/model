...
from respond_model.model_mixins.clinical_review.clinical_review import (
...
class GlucoseResult(GlucoseModelMixin, TestCrfModelMixin, edc_models.BaseUuidModel):
